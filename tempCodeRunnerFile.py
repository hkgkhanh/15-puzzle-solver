...
from fringe_astar import fringe_astar_solver
import os
import platform
import time
import copy
...
if __name__ == "__main__":
    ...
    #run astar-bfs
    start_time = time.perf_counter()
    fringe_astar_steps=fringe_astar_solver(fringe_astar_board, GOAL_STATE)
    ...
    all.solutions.append(fringe_astar_steps)
